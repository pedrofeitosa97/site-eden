...
export const godQuizQuestions: GodQuizQuestion[] = [
  {
    ...
    options: [
      ...
      { text: "Organizo todo mundo — cada um no seu posto, ninguém fica pra trás", weights: { hera: 3, atena: 1 } },
    ],
  },
  {
    id: "g2",
    ...
    options: [
      ...
      { text: "Minha lábia — eu convenço qualquer pessoa de qualquer coisa", weights: { hermes: 3, afrodite: 1 } },
    ],
  },
  {
    id: "g3",
    ...
    options: [
      ...
      { text: "Uma floresta silenciosa, iluminada só pela lua", weights: { artemis: 3, demeter: 1 } },
      { text: "Uma oficina cheia de ferramentas e projetos pela metade", weights: { hefesto: 3, atena: 1 } },
    ],
  },
  {
    id: "g4",
    ...
    options: [
      ...
      { text: "Frieza — me afasto quando me machucam", weights: { hades: 3, hefesto: 1 } },
      ...
      { text: "Rancor — até perdoo, mas nunca esqueço", weights: { hera: 3, hades: 1 } },
    ],
  },
  {
    id: "g5",
    ...
    options: [
      { text: "Comandar o raio — e ser obedecido até pelo céu", weights: { zeus: 3 } },
      { text: "Controlar o mar e as tempestades com um gesto", weights: { poseidon: 3 } },
      { text: "Caminhar entre sombras e falar com os mortos", weights: { hades: 3 } },
      { text: "Saber a resposta certa antes mesmo da pergunta", weights: { atena: 3 } },
      { text: "Vencer qualquer batalha, contra qualquer inimigo", weights: { ares: 3 } },
      { text: "Ler corações e nunca ser esquecido(a)", weights: { afrodite: 3 } },
      { text: "Curar com as mãos e ouvir o futuro na música", weights: { apolo: 3 } },
      { text: "Nunca errar o alvo e entender a língua dos animais", weights: { artemis: 3 } },
      { text: "Transformar qualquer noite numa lenda que ninguém esquece", weights: { dionisio: 3 } },
      { text: "Entrar nos sonhos e viver neles o que eu quiser", weights: { hipnos: 3 } },
      { text: "Um olhar que enxerga toda mentira — e faz reis se ajoelharem", weights: { hera: 3 } },
      { text: "Fazer a terra florescer — ou secar — com um toque", weights: { demeter: 3 } },
      { text: "Forjar qualquer coisa com as mãos — até armas dignas de deuses", weights: { hefesto: 3 } },
      { text: "Estar em qualquer lugar antes de todos — nenhuma porta fechada", weights: { hermes: 3 } },
    ],
  },
  {
    id: "g6",
    ...
    options: [
      ...
      { text: "Cuidado — alguém que rega o que ama todos os dias", weights: { demeter: 3, hera: 1 } },
    ],
  },
  {
    id: "g7",
  ...
  },
  {
    ...
    options: [
      ...
      { text: "Cozinhando pra galera toda — mesa cheia é vida boa", weights: { demeter: 3, hera: 1 } },
    ],
  },
  {
    id: "g10",
    ...
    options: [
      ...
      { text: "Dou um jeito — sempre existe um atalho que ninguém viu", weights: { hermes: 3, atena: 1 } },
    ],
  },
  {
    id: "g11",
  ...
  },
  {
    ...
    options: [
      ...
      { text: "\"Pode deixar que eu resolvo\" — e eu resolvo mesmo", weights: { hefesto: 3, demeter: 1 } },
    ],
  },
  {
    id: "g13",
    ...
    options: [
      { text: "Parto pro embate — levanto a voz se for preciso", weights: { ares: 3, zeus: 1 } },
      { text: "Fico frio(a) e desmonto o argumento com lógica", weights: { atena: 3, hades: 1 } },
      { text: "Me fecho na hora — processo tudo por dentro, sozinho(a)", weights: { hefesto: 2, hipnos: 2 } },
      { text: "Apaziguo — não deixo ninguém sair sangrando", weights: { demeter: 3, hera: 1 } },
      { text: "Solto uma piada pra desarmar o clima", weights: { dionisio: 3, hermes: 1 } },
      { text: "Saio antes de explodir — melhor sumir que dizer o que não volta", weights: { poseidon: 2, artemis: 2 } },
    ],
  },
  {
    id: "g14",
    ...
    options: [
      { text: "Ser esquecido(a) — passar pelo mundo sem deixar marca", weights: { apolo: 3, afrodite: 1 } },
      { text: "Ser traído(a) por quem eu mais confiei", weights: { hera: 3, hades: 1 } },
      { text: "Ficar preso(a) — numa rotina, numa gaiola, numa versão de mim", weights: { poseidon: 2, hermes: 2 } },
      { text: "Ver quem eu amo sofrer sem poder impedir", weights: { demeter: 3, ares: 1 } },
      { text: "Deixar alguém me conhecer de verdade — e ser rejeitado(a)", weights: { hefesto: 3, hipnos: 1 } },
      { text: "Depender tanto de alguém que eu me perca de mim", weights: { artemis: 3, atena: 1 } },
      { text: "Sentir que a vida passou e eu esqueci de vivê-la", weights: { dionisio: 3, zeus: 1 } },
    ],
  },
];
